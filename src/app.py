...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 20,
        "participants": ["ivy@mergington.edu", "leo@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and creative crafts",
        "schedule": "Mondays, 3:30 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["maya@mergington.edu", "sophia@mergington.edu"]
    },
    "Drama Workshop": {
        "description": "Practice acting, improv, and stage production",
        "schedule": "Thursdays, 3:45 PM - 5:15 PM",
        "max_participants": 16,
        "participants": ["jordan@mergington.edu", "zoe@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Math Olympiad": {
        "description": "Practice advanced math problems and competition prep",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
